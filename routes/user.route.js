...
router.post('/addUserGoogle', userInterceptor.validateNewUser, usersController.createUser);
router.post('/addUser', userInterceptor.validateNewUser, usersController.createTemporaryUser);
router.post('/validateCode', usersController.validateCode);
