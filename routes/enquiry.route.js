...
router.post('/sendAddOrgEnquiry/:userId/:type', verifyToken, upload.single('file'), enquiryInterceptor.validateNewOrgEnquiry, enquiryInterceptor.validateUserId, enquiryController.sendOrgEnquiry);
