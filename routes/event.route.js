...
router.post('/addEvent', verifyToken, eventInterceptor.validateNewEvent, upload.single('file'), eventController.createEvent);
router.post('/addEvent/:token', eventInterceptor.validateTokenReuse, verifyToken, eventInterceptor.validateNewEvent, upload.single('file'), eventController.createEvent);
